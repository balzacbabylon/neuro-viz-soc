...
BEGIN
  outputgen3: FOR k1 IN 0 TO 28 GENERATE
    Y_block_signed(k1) <= signed(Y_block(k1));
  END GENERATE;

  outputgen1: FOR k1 IN 0 TO 899 GENERATE
    outputgen2: FOR k2 IN 0 TO 28 GENERATE
      K_signed(k1, k2) <= signed(K(k1, k2));
    END GENERATE;
  END GENERATE;

  eeg_inverse_hls_float_fixpt_1_output : PROCESS (K_signed, Y_block_signed)
  ...
  END PROCESS eeg_inverse_hls_float_fixpt_1_output;
